...
public class harrisHealthSystem {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			eyes.open(driver, "HARRIS HEALTH SYSTEM", "4.0.108.1 -Harris Health");
			// -UAT-- URL
			//driver.get("https://s6143962.ebscomedical.com/");
			// -UAT-- URL
			driver.get("https://uat-nvcvooy-mkzzdqyg7x6ca.us-3.platformsh.site/");
			...
			Thread.sleep(5000);
			// 3rd checkpoint
			eyes.checkWindow("-UAT- Site SEARCH ALL result Page [4.0.108.1]");
			...
			Thread.sleep(6000);
			// 4th
			eyes.checkWindow("-UAT- Journals Results c - Page-4");

...
public class FultonCountryHealthCare {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			eyes.open(driver, "FULTON COUNTRY HEALTH CARE", "FULTON - 4.0.1.109b");
			// -UAT--- URL
			//driver.get("https://ns006251.ebscomedical.com/");
			// -UAT--- URL
			driver.get("https://uat-nvcvooy-ku5qnwotd7m6a.us-3.platformsh.site/");
			...
			Thread.sleep(5000);
			// 3rd checkpoint
			eyes.checkWindow("-UAT- Site MEDLINE result Page [4.0.1.109b]");

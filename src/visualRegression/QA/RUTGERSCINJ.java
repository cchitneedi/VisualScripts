...
public class RUTGERSCINJ {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			eyes.open(driver, "RUTGERS CINJ - [4.0.93dd]", "RUTGERS-[4.0.93dd]");
			
			 //driver.get("https://rutgerscinjhldemo.stacksplatform.com/");
			driver.get("https://uat-nvcvooy-mymzdxyzebkiu.us-4.platformsh.site/");

	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.manage().timeouts().pageLoadTimeout(60, TimeUnit.SECONDS);
			//cchitneedi@ebsco.com
				...
				try {
					eyes.open(driver, "PATHWAYS2RESEARCH DESKTOP VIEW Account", "My Account Section -[4.0.82]");
					...
					Thread.sleep(1000);
					//eyes.checkWindow("MASTER SITE [4.0.82] Login Page");
					...
					Thread.sleep(2000);
					//1st
					eyes.checkWindow("UAT SITE [4.0.82b] My-Account Page mode1");
					driver.findElement(By.id("toggle-light-dark")).click();
					Thread.sleep(2000);
					//2nd
					eyes.checkWindow("UAT SITE [4.0.82b] My-Account Page mode2");
					driver.findElement(By.linkText("Your Saved List")).click();
					Thread.sleep(2000);
					//3rd
					eyes.checkWindow("UAT SITE [4.0.82b] Saved-List Page mode1");
					driver.findElement(By.id("toggle-light-dark")).click();
					Thread.sleep(2000);
					//4th
					eyes.checkWindow("UAT SITE [4.0.82b] Saved-List Page mode2");
					driver.navigate().back();
					driver.findElement(By.linkText("Your Saved Searches")).click();
					Thread.sleep(2000);
					//5th
					eyes.checkWindow("UAT SITE [4.0.82b] Saved-Searches Page mode1");
					driver.findElement(By.id("toggle-light-dark")).click();
					Thread.sleep(2000);
					//6th
					eyes.checkWindow("UAT SITE [4.0.82b] Saved-Searches Page mode2");
					driver.navigate().back();
					...
					Thread.sleep(1000);
					//7th
					eyes.checkWindow("UAT SITE [4.0.82b] Search-Results Page");
					driver.findElement(By.id("toggle-light-dark")).click();
					Thread.sleep(1000);
					//8th
					eyes.checkWindow("UAT SITE [4.0.82b] Search-Results Page mode2");

...
public class WORKPLACEOPTIONS {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			eyes.open(driver, "WORKPLACE OPTIONS - [4.0.93d]", "WORKPLACE-[4.0.93d]");

			driver.get("https://workplacehldemo.stacksplatform.com");
			//driver.get("https://uat-nvcvooy-zjpxwubec3i3u.us-4.platformsh.site/");

...
public class blackpoolEBSCO {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			eyes.open(driver, "BLACKPOOL TEACHING HOSPITALS 4.0.101e", "4.0.101e-BLACKPOOL");
			// Master URL
			...
			Thread.sleep(2000);
			// 1st checkpoint
			eyes.checkWindow("-UAT- Home Page 4.0.101e");
			WebElement ele;
			...
			clickfunction4 = driver.findElement(By.xpath(
					"//input[@id='edit-search-form-stacks-external-catalogs-customheath-business-elite-search-bar-container-actions-submit']"));
			JavascriptExecutor executor4 = (JavascriptExecutor) driver;
			executor4.executeScript("arguments[0].click();", clickfunction4);
			Thread.sleep(5000);
			// 3rd checkpoint
			eyes.checkWindow("-UAT- Site Health Business Elite result Page [4.0.101e]");
			...
			Thread.sleep(5000);
			// 4th checkpoint
			eyes.checkWindow("-UAT- Site Nursing eBooks result Page [4.0.101e]");
			...
			WebElement gdfgdsf = driver.findElement(By.xpath("//a[contains(text(),'PubMed - 725')]"));
			gdfgdsf.click();
			Thread.sleep(6000);
			// 4th checkpoint
			eyes.checkWindow("-UAT- CINAHL Results page 4.0.101e");
			...
			Thread.sleep(3000);
			// 6th checkpoint
			eyes.checkWindow("-UAT- ARTICLE Results Page 4.0.101e");

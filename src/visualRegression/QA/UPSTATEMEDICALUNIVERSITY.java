...
public class UPSTATEMEDICALUNIVERSITY {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			eyes.open(driver, "UPSTATE MEDICAL UNIVERSITY - [4.0.93d]", "UPSTATE-[4.0.93d]");
			
			// driver.get("https://sunyhldemo.stacksplatform.com");
			driver.get("https://uat-nvcvooy-qtm3cur25rnfk.us-4.platformsh.site/");

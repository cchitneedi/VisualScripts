...
public class GRIFFINHEALTHHOSPITAL {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			eyes.open(driver, "GRIFFIN HEALTH - [4.0.95.1a]", "GRIFFIN-[4.0.95.1a]");
			
			//driver.get("https://griffinhldemo.stacksplatform.com/");
			driver.get("https://uat-nvcvooy-hribtp2w5jyzs.us-4.platformsh.site/");

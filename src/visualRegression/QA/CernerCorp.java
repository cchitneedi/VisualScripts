...
public class CernerCorp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			eyes.open(driver, "Cerner Corp-4.0.89d", "4.0.89d-Cerner Corp");
			//Master URL
			...
			Thread.sleep(3000);
			eyes.checkWindow("UAT Home Page 4.0.89d");
			driver.findElement(By.xpath("//body/div[1]/div[2]/div[5]/div[1]/div[2]/div[1]/main[1]/div[1]/div[3]/article[1]/div[1]/div[1]/div[1]/div[1]/nav[1]/ul[1]/li[12]/a[1]")).click();
			Thread.sleep(3000);
			// 2nd checkpoint
			eyes.checkWindow("UAT Last Page 4.0.89d");
			...
			Thread.sleep(5000);
			// 3rd checkpoint
			eyes.checkWindow("UAT Search Yellow Fever Result Page 4.0.89d");
			...
			Thread.sleep(6000);
			// 4th checkpoint
			eyes.checkWindow("UAT Pubmed Results page 4.0.89d");
			driver.findElement(By.xpath("//a[@aria-label='grid view']")).click();
			Thread.sleep(2000);
			// 5th
			eyes.checkWindow("UAT Grid View Results Page 4.0.89d");
			driver.findElement(By.xpath("//a[contains(text(),'Equatorial Guinea.')]")).click();
			ArrayList<String> tabs2 = new ArrayList<String>(driver.getWindowHandles());
			driver.switchTo().window(tabs2.get(1));
			Thread.sleep(3000);
			// 6th checkpoint
			eyes.checkWindow("UAT Equatorial Results Page 4.0.89d");
			...
			Thread.sleep(4000);
			// 7th
			eyes.checkWindow("UAT Last Results Page 4.0.89d");		
		}
		finally {
			driver.quit();
